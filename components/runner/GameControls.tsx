  ...
  return (
    <div className="pointer-events-auto absolute bottom-6 left-1/2 z-20 flex -translate-x-1/2 flex-col items-center gap-2">
      ...
      <button
        ...
        className="flex h-14 w-14 items-center justify-center rounded-lg border border-[rgba(0,240,255,0.3)] bg-[#0E1415] text-xl text-[#00F0FF] hover:border-[rgba(0,240,255,0.6)] active:bg-[#1a3a3c]"
      >
        ↑
      </button>
