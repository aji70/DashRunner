      ...
      <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto px-4 py-8">
        ...
        >
          <div className="text-center">
            <h1 className="font-orbitron text-3xl font-bold text-cyan-300">SELECT ROUTE</h1>
            <p className="mt-2 font-rajdhani text-sm text-cyan-200/70">Choose your city and start racing</p>
          </div>
          ...
          <motion.button
            ...
            onClick={onStartRace}
            className="w-full rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 px-6 py-3 font-orbitron font-bold text-white transition-all hover:shadow-lg hover:shadow-cyan-500/50"
          >
            START RACE
          </motion.button>
        </motion.div>
