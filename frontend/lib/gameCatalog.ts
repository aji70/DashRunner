...
export const CITY_ROUTES: CityRoute[] = [
  ...
  { id: 3, name: "Evergreen Sprint", tagline: "Forest asphalt & sweeping bends", region: "Deep forest" },
  ...
  { id: 7, name: "Tide Break", tagline: "Coastal sweepers & sea-salt air", region: "Seaside bay" },
  ...
  { id: 12, name: "Synth Wave", tagline: "Midnight city express & rain-slick tarmac", region: "Cyber underground" },
];
